...
<body>
  ...
  <header id="header">
    <div id="banner">
      ...
      <p class="site-slogan">Apparently I must :)</p>
      <a href="index.php">
        <img class="site-logo" src="img/alien_spaceship.svg" alt="logo" width="100" height="100" />
      </a>
    </div>
    <div id="nav_wrap">
...
..:      /JJ
    ...
    <p>&copy; Julia Wells, wells.julia@gmail.com</p>
